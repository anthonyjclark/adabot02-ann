...
\begin{figure*}[!ht]
    ...
    \subfloat[]{\includegraphics[width=\columnwidth]{figures/4-results/fsm01-strut-forward.png}}

    \subfloat[]{\includegraphics[width=\columnwidth]{figures/4-results/fsm01-left-right.png}}
