...
genome_to_args_map = [
    ...
    {'name': 'weg_extension_slope'    , 'default': 0.5 , 'minval': 0   , 'maxval': 1   , 'T': float},
    {'name': 'weg_extension_intercept', 'default': 0.5 , 'minval': 0   , 'maxval': 1   , 'T': float},
    {'name': 'forward_speed_scale'    , 'default': 1   , 'minval': 0   , 'maxval': 1   , 'T': float},
    {'name': 'forward_to_left_lo'     , 'default': 0.17, 'minval': 0   , 'maxval': pi/2, 'T': float},
    {'name': 'forward_to_right_hi'    , 'default':-0.17, 'minval':-pi/2, 'maxval': 0   , 'T': float},
    {'name': 'left_left_scale'        , 'default':-1   , 'minval':-1   , 'maxval': 1   , 'T': float},
    {'name': 'left_right_scale'       , 'default': 1   , 'minval':-1   , 'maxval': 1   , 'T': float},
    {'name': 'left_to_forward_hi'     , 'default': 0.08, 'minval': 0   , 'maxval': pi/2, 'T': float},
    {'name': 'right_left_scale'       , 'default': 1   , 'minval':-1   , 'maxval': 1   , 'T': float},
    {'name': 'right_right_scale'      , 'default':-1   , 'minval':-1   , 'maxval': 1   , 'T': float},
    {'name': 'right_to_forward_lo'    , 'default':-0.08, 'minval':-pi/2, 'maxval': 0   , 'T': float},
]
